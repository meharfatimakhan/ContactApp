...
//        }
    ...
    protected void onStart() {
        ...
        Toast.makeText(getApplicationContext(), "My Contact List", Toast.LENGTH_LONG).show();
        addContactBtn =  (FloatingActionButton) findViewById(R.id.addContactBtn);
        addContactBtn.setScaleType(ImageView.ScaleType.CENTER);
